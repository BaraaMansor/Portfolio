...
const Projects = () => {
  const projects = [
    ...
    },
    {
      ...
      description: "A responsive weather application that provides current weather, forecasts, and interactive maps using multiple weather APIs.",
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid gap-8">
            {projects.map((project, index) => (
              ...
              >
                <div className={`grid ${index % 2 === 0 ? "lg:grid-cols-2" : "lg:grid-cols-2"} gap-6 items-center`}>
                  {/* Project Image */}
                  <div className={`${index % 2 === 0 ? "order-1" : "order-2 lg:order-1"} overflow-hidden rounded-lg`}>
                    <img
                      src={project.image}
                      alt={project.title}
                  ...
                  {/* Project Content */}
                  <div className={`${index % 2 === 0 ? "order-2" : "order-1 lg:order-2"} space-y-4`}>
